...
export async function registerAdminRoutes(app: Express) {
  ...
  app.get("/admin/api/settings/:key", authenticateAdmin, async (req: AdminAuthRequest, res: Response) => {
    try {
  ...
  app.post("/admin/api/settings", authenticateAdmin, async (req: AdminAuthRequest, res: Response) => {
    try {
      ...
      const setting = await storage.setSetting(key, value, description, category);
      res.json({ message: "Setting created/updated successfully", setting });
    } catch (error) {
  ...
  app.put("/admin/api/settings/:key", authenticateAdmin, async (req: AdminAuthRequest, res: Response) => {
    try {
  ...
  app.delete("/admin/api/settings/:key", authenticateAdmin, async (req: AdminAuthRequest, res: Response) => {
    try {
