            ...
            <div className="flex items-center space-x-8">
              ...
              {categories?.slice(0, 4).map((category: any) => (
                <a 
                  ...
                  className="hidden lg:block inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 font-medium no-underline"
                >
                  {category.name}
                </a>
              ))}
