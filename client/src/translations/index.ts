...
export interface TranslationKeys {
  ...
  'account.updating': string;
  'account.updateInvoiceSettings': string;
  ...
  'terms.hero.lastUpdated': string;
  'terms.company.title': string;
  'terms.company.tax': string;
  'terms.introduction.title': string;
  'terms.introduction.ownership': string;
  'terms.introduction.company': string;
  'terms.introduction.platform': string;
  'terms.introduction.acceptance': string;
  'terms.introduction.agreement': string;
  'terms.purpose.title': string;
  'terms.purpose.description': string;
  'terms.purpose.marketplace': string;
  'terms.purpose.loyalty': string;
  'terms.purpose.payments': string;
  'terms.purpose.information': string;
  'terms.purpose.audience': string;
  'terms.purpose.access': string;
  'terms.intellectual.title': string;
  'terms.intellectual.ownership': string;
  'terms.intellectual.rights': string;
  'terms.intellectual.usage': string;
  'terms.intellectual.prohibited': string;
  'terms.intellectual.violations': string;
  'terms.usage.title': string;
  'terms.usage.general': string;
  'terms.usage.prohibited': string;
  'terms.usage.violations': string;
  'terms.usage.contact': string;
  'terms.usage.information': string;
  'terms.liability.title': string;
  'terms.liability.efforts': string;
  'terms.liability.disclaimers': string;
  'terms.liability.information': string;
  'terms.liability.limitations': string;
  'terms.liability.thirdparty': string;
  'terms.liability.risk': string;
  'terms.modifications.title': string;
  'terms.modifications.rights': string;
  'terms.modifications.recommendations': string;
  'terms.modifications.discontinuation': string;
  'terms.jurisdiction.title': string;
  'terms.jurisdiction.law': string;
  'terms.jurisdiction.disputes': string;
  'terms.jurisdiction.consumer': string;
  'terms.privacy.title': string;
  'terms.privacy.importance': string;
  'terms.privacy.consent': string;
  'terms.privacy.contact': string;
  'terms.footer.questions': string;
  'terms.footer.support': string;
  'terms.footer.privacy': string;
}
...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    'account.updateInvoiceSettings': 'Update Invoice Settings',
    ...
    'terms.hero.subtitle': 'Please read these terms carefully before using our platform and services',
    'terms.hero.lastUpdated': 'Last updated: June 25, 2025',
    'terms.company.title': 'Company Information',
    'terms.company.tax': 'Tax Registration Number',
    'terms.introduction.title': 'Introduction and Acceptance of Terms',
    'terms.introduction.ownership': 'The website www.kitchen-off.com is owned and operated by NAMARTE (hereinafter referred to as "KitchenOff" or the "Company"), a joint stock company based in Bucharest, District 2, Calea Moșilor no. 158, Romania, with tax registration number RO16582983.',
    'terms.introduction.company': 'NAMARTE is a company in the food technology sector, providing customers from the HORECA industry—especially restaurants—a solution for customer loyalty and more (software app) designed to optimize their clients.',
    'terms.introduction.platform': 'This Website and mobile apps is our official platform through which we present information about KitchenOff services and solutions. Also, via this Website, interested parties can contact us to request additional details about our offer or to initiate a collaboration.',
    'terms.introduction.acceptance': 'Accessing and using the Website implies full and unconditional acceptance of these Terms and Conditions. If you do not agree with any of the terms stipulated below, please discontinue using the Website.',
    'terms.introduction.agreement': 'By continuing to browse the Website, you confirm that you have read, understood, and agree to abide by this document, along with KitchenOff\'s Privacy Policy and Cookie Policy.',
    'terms.purpose.title': 'Purpose and Functionality of the Website',
    'terms.purpose.description': 'The website www.kitchen-off.com is a web-app platform through which KitchenOff sells vouchers to restaurants, with the goal of improving client loyalty and food experience.',
    'terms.purpose.marketplace': 'Marketplace platform – a centralized system connecting consumers with restaurants facilitating online orders and advance discount purchases under certain conditions.',
    'terms.purpose.loyalty': 'Restaurant loyalty systems by Prepaid Vouchers.',
    'terms.purpose.payments': 'Integrated payments – card payment solutions (debit/credit) both online and via mobile.',
    'terms.purpose.information': 'The Website aims to provide up-to-date information about these services and technologies, about KitchenOff\'s mission and vision, as well as case studies or partner testimonials.',
    'terms.purpose.audience': 'The Website\'s target audience consists of hospitality industry professionals interested in digitizing their businesses, as well as consumers.',
    'terms.purpose.access': 'Access to the Website is provided free of charge to users and is not conditional on creating a user account.',
    'terms.intellectual.title': 'Intellectual Property',
    'terms.intellectual.ownership': 'The content and design of the Website are the exclusive property of NAMARTE or its partners and are protected by applicable copyright legislation and other intellectual property rights.',
    'terms.intellectual.rights': 'NAMARTE holds all intellectual property rights to the technology, software platform, and content provided through this Website.',
    'terms.intellectual.usage': 'Users may access and use the Website content solely for their personal, non-commercial information.',
    'terms.intellectual.prohibited': 'Without our prior written consent, you are not entitled to copy, reproduce, distribute, modify, or exploit the Website content for commercial purposes.',
    'terms.intellectual.violations': 'Any unauthorized use of the Website content constitutes a breach of these conditions and may violate applicable law.',
    'terms.usage.title': 'Use of the Website',
    'terms.usage.general': 'The Website may be used by any visitor free of charge to obtain information about KitchenOff products and offers.',
    'terms.usage.prohibited': 'You agree not to use the Website for illegal activities, unauthorized access attempts, transmitting harmful code, or sending unlawful content.',
    'terms.usage.violations': 'Violation of these obligations may result in restriction of access and notification of competent authorities.',
    'terms.usage.contact': 'The Website provides contact forms through which you can request information or negotiate service contracts.',
    'terms.usage.information': 'Please provide accurate and complete information when using contact forms.',
    'terms.liability.title': 'Limitation of Liability',
    'terms.liability.efforts': 'NAMARTE makes considerable efforts to ensure the accuracy and timeliness of information on the Website.',
    'terms.liability.disclaimers': 'However, the Website content is provided for general informational purposes, and the Company does not guarantee complete accuracy or error-free operation.',
    'terms.liability.information': 'Information about products and services is provided for informational purposes only and should not be construed as firm guarantees.',
    'terms.liability.limitations': 'To the fullest extent permitted by law, NAMARTE shall not be liable for any losses or damages resulting from use of the Website.',
    'terms.liability.thirdparty': 'The Website may contain links to third-party websites. NAMARTE assumes no responsibility for external site content.',
    'terms.liability.risk': 'By using the Website, you expressly agree that you do so at your own risk.',
    'terms.modifications.title': 'Right to Modify the Terms',
    'terms.modifications.rights': 'NAMARTE reserves the right to modify these Terms and Conditions at any time to reflect changes in legislation or functionalities.',
    'terms.modifications.recommendations': 'We recommend checking this page periodically to stay updated on any changes.',
    'terms.modifications.discontinuation': 'If you do not agree with changes made, please discontinue using the Website.',
    'terms.jurisdiction.title': 'Governing Law and Jurisdiction',
    'terms.jurisdiction.law': 'These Terms and Conditions are governed by the laws in force in Romania.',
    'terms.jurisdiction.disputes': 'Any disputes will be resolved amicably or referred to competent courts in Bucharest, Romania.',
    'terms.jurisdiction.consumer': 'Consumer protection legislation rights are not affected by these provisions.',
    'terms.privacy.title': 'Personal Data Processing',
    'terms.privacy.importance': 'Your personal data privacy is important to us. Personal data collected through this Website will be processed in accordance with applicable legislation, including GDPR.',
    'terms.privacy.consent': 'By using the contact form or other functionalities, you consent to NAMARTE processing your data in accordance with our Privacy Policy.',
    'terms.privacy.contact': 'For more information on privacy practices, contact us at info@kitchen-off.com or via the contact form.',
    'terms.footer.questions': 'If you have any questions about these Terms and Conditions, please contact us:',
    'terms.footer.support': 'Contact Support',
    'terms.footer.privacy': 'Privacy Questions',
  },
  ...
  es: {
    ...
    'account.companyAddress': 'Dirección de la Empresa',
    'account.billingContact': 'Información de Contacto de Facturación',
    'account.streetAddress': 'Dirección',
    'account.city': 'Ciudad',
    'account.stateProvince': 'Estado/Provincia',
    'account.zipCode': 'Código Postal',
    'account.country': 'País',
    'account.billingEmail': 'Email de Facturación',
    'account.billingPhone': 'Teléfono de Facturación',
    'account.deliveryAddress': 'Dirección de Entrega (si es diferente de la dirección de la empresa)',
    'account.deliveryStreetAddress': 'Dirección de Entrega',
    'account.deliveryInstructions': 'Instrucciones de Entrega',
    'account.updating': 'Actualizando...',
    'account.updateInvoiceSettings': 'Actualizar Configuración de Factura',
  ...
  fr: {
    ...
    'account.companyAddress': 'Adresse de l\'Entreprise',
    'account.billingContact': 'Informations de Contact de Facturation',
    'account.streetAddress': 'Adresse',
    'account.city': 'Ville',
    'account.stateProvince': 'État/Province',
    'account.zipCode': 'Code Postal',
    'account.country': 'Pays',
    'account.billingEmail': 'Email de Facturation',
    'account.billingPhone': 'Téléphone de Facturation',
    'account.deliveryAddress': 'Adresse de Livraison (si différente de l\'adresse de l\'entreprise)',
    'account.deliveryStreetAddress': 'Adresse de Livraison',
    'account.deliveryInstructions': 'Instructions de Livraison',
    'account.updating': 'Mise à jour...',
    'account.updateInvoiceSettings': 'Mettre à jour les Paramètres de Facture',
  ...
  de: {
    ...
    'account.companyAddress': 'Unternehmensadresse',
    'account.billingContact': 'Rechnungskonktaktinformationen',
    'account.streetAddress': 'Straßenadresse',
    'account.city': 'Stadt',
    'account.stateProvince': 'Bundesland/Provinz',
    'account.zipCode': 'Postleitzahl',
    'account.country': 'Land',
    'account.billingEmail': 'Rechnungs-E-Mail',
    'account.billingPhone': 'Rechnungstelefon',
    'account.deliveryAddress': 'Lieferadresse (falls abweichend von der Unternehmensadresse)',
    'account.deliveryStreetAddress': 'Lieferstraßenadresse',
    'account.deliveryInstructions': 'Lieferinstruktionen',
    'account.updating': 'Aktualisierung...',
    'account.updateInvoiceSettings': 'Rechnungseinstellungen Aktualisieren',
    'auth.login': 'Anmelden',
  ...
  ro: {
    ...
    'account.companyAddress': 'Adresa Companiei',
    'account.billingContact': 'Informații Contact Facturare',
    'account.streetAddress': 'Adresa Străzii',
    'account.city': 'Oraș',
    'account.stateProvince': 'Județ/Provincie',
    'account.zipCode': 'Cod Poștal',
    'account.country': 'Țară',
    'account.billingEmail': 'Email Facturare',
    'account.billingPhone': 'Telefon Facturare',
    'account.deliveryAddress': 'Adresa de Livrare (dacă este diferită de adresa companiei)',
    'account.deliveryStreetAddress': 'Adresa de Livrare',
    'account.deliveryInstructions': 'Instrucțiuni de Livrare',
    'account.updating': 'Se actualizează...',
    'account.updateInvoiceSettings': 'Actualizează Setările Facturii',
  ...
  it: {
    ...
    'account.companyAddress': 'Indirizzo Aziendale',
    'account.billingContact': 'Informazioni Contatto Fatturazione',
    'account.streetAddress': 'Indirizzo',
    'account.city': 'Città',
    'account.stateProvince': 'Stato/Provincia',
    'account.zipCode': 'Codice Postale',
    'account.country': 'Paese',
    'account.billingEmail': 'Email Fatturazione',
    'account.billingPhone': 'Telefono Fatturazione',
    'account.deliveryAddress': 'Indirizzo di Consegna (se diverso dall\'indirizzo aziendale)',
    'account.deliveryStreetAddress': 'Indirizzo di Consegna',
    'account.deliveryInstructions': 'Istruzioni di Consegna',
    'account.updating': 'Aggiornamento...',
    'account.updateInvoiceSettings': 'Aggiorna Impostazioni Fattura',
  ...
  pt: {
    ...
    'account.companyAddress': 'Endereço da Empresa',
    'account.billingContact': 'Informações de Contato de Faturamento',
    'account.streetAddress': 'Endereço',
    'account.city': 'Cidade',
    'account.stateProvince': 'Estado/Província',
    'account.zipCode': 'Código Postal',
    'account.country': 'País',
    'account.billingEmail': 'Email de Faturamento',
    'account.billingPhone': 'Telefone de Faturamento',
    'account.deliveryAddress': 'Endereço de Entrega (se diferente do endereço da empresa)',
    'account.deliveryStreetAddress': 'Endereço de Entrega',
    'account.deliveryInstructions': 'Instruções de Entrega',
    'account.updating': 'Atualizando...',
    'account.updateInvoiceSettings': 'Atualizar Configurações da Fatura',
  ...
  zh: {
    ...
    'account.companyAddress': '公司地址',
    'account.billingContact': '账单联系信息',
    'account.streetAddress': '街道地址',
    'account.city': '城市',
    'account.stateProvince': '州/省',
    'account.zipCode': '邮政编码',
    'account.country': '国家',
    'account.billingEmail': '账单邮箱',
    'account.billingPhone': '账单电话',
    'account.deliveryAddress': '配送地址（如果与公司地址不同）',
    'account.deliveryStreetAddress': '配送街道地址',
    'account.deliveryInstructions': '配送说明',
    'account.updating': '更新中...',
    'account.updateInvoiceSettings': '更新发票设置',
  ...
  ja: {
    ...
    'account.billingContact': '請求先連絡先情報',
    'account.streetAddress': '住所',
    'account.city': '市区町村',
    'account.stateProvince': '都道府県',
    'account.zipCode': '郵便番号',
    'account.country': '国',
    'account.billingEmail': '請求先メール',
    'account.billingPhone': '請求先電話',
    'account.deliveryAddress': '配送先住所（会社住所と異なる場合）',
    'account.deliveryStreetAddress': '配送先住所',
    'account.deliveryInstructions': '配送指示',
    'account.updating': '更新中...',
    'account.updateInvoiceSettings': '請求書設定を更新',
  ...
  ko: {
    ...
    'account.companyAddress': '회사 주소',
    'account.billingContact': '청구 연락처 정보',
    'account.streetAddress': '주소',
    'account.city': '도시',
    'account.stateProvince': '주/도',
    'account.zipCode': '우편번호',
    'account.country': '국가',
    'account.billingEmail': '청구 이메일',
    'account.billingPhone': '청구 전화번호',
    'account.deliveryAddress': '배송 주소 (회사 주소와 다른 경우)',
    'account.deliveryStreetAddress': '배송지 주소',
    'account.deliveryInstructions': '배송 지시사항',
    'account.updating': '업데이트 중...',
    'account.updateInvoiceSettings': '인보이스 설정 업데이트',
  ...
  ar: {
    ...
    'account.companyAddress': 'عنوان الشركة',
    'account.billingContact': 'معلومات جهة الاتصال للفوترة',
    'account.streetAddress': 'عنوان الشارع',
    'account.city': 'المدينة',
    'account.stateProvince': 'الولاية/المحافظة',
    'account.zipCode': 'الرمز البريدي',
    'account.country': 'البلد',
    'account.billingEmail': 'بريد الفوترة الإلكتروني',
    'account.billingPhone': 'هاتف الفوترة',
    'account.deliveryAddress': 'عنوان التسليم (إذا كان مختلفاً عن عنوان الشركة)',
    'account.deliveryStreetAddress': 'عنوان شارع التسليم',
    'account.deliveryInstructions': 'تعليمات التسليم',
    'account.updating': 'جاري التحديث...',
    'account.updateInvoiceSettings': 'تحديث إعدادات الفاتورة',
