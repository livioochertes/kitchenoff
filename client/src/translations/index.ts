...
export interface TranslationKeys {
  ...
  'checkout.error': string;
    ...
    'checkout.billingAddress': string;
    'checkout.invoiceDetails': string;
    'checkout.clientType': string;
    'checkout.individual': string;
    'checkout.company': string;
    'checkout.identityDocument': string;
    'checkout.identityDocumentHint': string;
    'checkout.companyData': string;
    'checkout.companyName': string;
    'checkout.vatNumber': string;
    'checkout.registrationNumber': string;
    'checkout.sameAsBilling': string;
    'checkout.subtotal': string;
    'checkout.shipping': string;
    'checkout.shippingFree': string;
    'checkout.vatIncluded': string;
    'checkout.voucherCode': string;
    'checkout.applyVoucher': string;
    'checkout.removeVoucher': string;
    'checkout.total': string;
    'checkout.next': string;
    'checkout.back': string;
    'checkout.stepContact': string;
    'checkout.stepAddress': string;
    'checkout.stepPayment': string;
    'checkout.county': string;
    'checkout.cashOnDelivery': string;
    'checkout.cashOnDeliveryDesc': string;
    'checkout.cashOnDeliveryNote': string;
    'checkout.notes': string;
    'checkout.notesPlaceholder': string;
    'checkout.emptyCart': string;
    'checkout.emptyCartDesc': string;
    'checkout.goShopping': string;
    'checkout.guestEmail': string;
    'checkout.loginPrompt': string;
    'checkout.loginLink': string;
    ...
    'checkout.company_field': string;
    'checkout.orderPlacedDesc': string;
    'checkout.orderFailed': string;
    'checkout.stripePayment': string;
    'checkout.revolutPayment': string;
    'checkout.paypalPayment': string;
    'checkout.enterVoucherCode': string;
    'checkout.voucherApplied': string;
    'checkout.voucherDiscountApplied': string;
    'checkout.invalidVoucher': string;
    'checkout.voucherValidationFailed': string;
    'checkout.emailPlaceholder': string;
    'checkout.phonePlaceholder': string;
    'checkout.countyPlaceholder': string;
    'checkout.selectCountry': string;
    'checkout.selectPayment': string;
...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    'checkout.error': 'Error placing order',
      ...
      'checkout.invoiceDetails': 'Invoice Details',
      'checkout.clientType': 'Client Type',
      'checkout.individual': 'Individual',
      'checkout.company': 'Company',
      'checkout.identityDocument': 'Identity Document (ID Series/Number)',
      'checkout.identityDocumentHint': 'ID card series and number (optional)',
      'checkout.companyData': 'Company data for invoicing',
      'checkout.companyName': 'Company Name',
      'checkout.vatNumber': 'VAT Number (CUI)',
      'checkout.registrationNumber': 'Registration Number',
      'checkout.sameAsBilling': 'Billing address is the same as shipping address',
      'checkout.subtotal': 'Subtotal',
      'checkout.shipping': 'Shipping',
      'checkout.shippingFree': 'Free',
      'checkout.vatIncluded': 'VAT ({0}% included)',
      'checkout.voucherCode': 'Voucher Code',
      'checkout.applyVoucher': 'Apply',
      ...
      'checkout.cashOnDeliveryDesc': 'Pay when you receive your order',
      'checkout.cashOnDeliveryNote': 'Please have the exact amount ready',
      'checkout.notes': 'Order Notes',
      'checkout.notesPlaceholder': 'Special instructions for your order...',
      ...
      'checkout.loginPrompt': 'Already have an account?',
      'checkout.loginLink': 'Login here',
      ...
      'checkout.company_field': 'Company (Optional)',
      'checkout.orderPlacedDesc': 'Thank you for your order. You will receive a confirmation email shortly.',
      'checkout.orderFailed': 'Order failed',
      'checkout.stripePayment': 'Credit/Debit Card (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Please enter a voucher code',
      'checkout.voucherApplied': 'Voucher Applied!',
      'checkout.voucherDiscountApplied': 'Discount of {0} {1} applied.',
      'checkout.invalidVoucher': 'Invalid voucher code',
      'checkout.voucherValidationFailed': 'Failed to validate voucher. Please try again.',
      'checkout.emailPlaceholder': 'your@email.com',
      'checkout.phonePlaceholder': '+40 7XX XXX XXX',
      'checkout.countyPlaceholder': 'e.g. Bucharest, Cluj, Ilfov',
  ...
  es: {
    ...
    'checkout.error': 'Error al realizar el pedido',
      ...
      'checkout.invoiceDetails': 'Detalles de Factura',
      'checkout.clientType': 'Tipo de Cliente',
      'checkout.individual': 'Particular',
      'checkout.company': 'Empresa',
      'checkout.identityDocument': 'Documento de Identidad (Serie/Número)',
      'checkout.identityDocumentHint': 'Serie y número del documento de identidad (opcional)',
      'checkout.companyData': 'Datos de empresa para facturación',
      'checkout.companyName': 'Nombre de Empresa',
      'checkout.vatNumber': 'Número de IVA (CIF)',
      'checkout.registrationNumber': 'Número de Registro',
      'checkout.sameAsBilling': 'La dirección de facturación es la misma que la de envío',
      'checkout.subtotal': 'Subtotal',
      'checkout.shipping': 'Envío',
      'checkout.shippingFree': 'Gratis',
      'checkout.vatIncluded': 'IVA ({0}% incluido)',
      'checkout.voucherCode': 'Código de Cupón',
      'checkout.applyVoucher': 'Aplicar',
      'checkout.removeVoucher': 'Eliminar cupón',
      'checkout.total': 'Total',
      'checkout.next': 'Siguiente',
      'checkout.back': 'Atrás',
      'checkout.stepContact': 'Contacto',
      'checkout.stepAddress': 'Dirección',
      'checkout.stepPayment': 'Pago',
      'checkout.county': 'Provincia',
      'checkout.cashOnDelivery': 'Pago Contra Reembolso',
      'checkout.cashOnDeliveryDesc': 'Pague cuando reciba su pedido',
      'checkout.cashOnDeliveryNote': 'Por favor tenga el importe exacto preparado',
      'checkout.notes': 'Notas del Pedido',
      'checkout.notesPlaceholder': 'Instrucciones especiales para su pedido...',
      'checkout.emptyCart': 'Su carrito está vacío',
      'checkout.emptyCartDesc': 'Agregue productos a su carrito antes de finalizar la compra.',
      'checkout.goShopping': 'Ir de Compras',
      'checkout.guestEmail': 'Dirección de Email',
      'checkout.loginPrompt': '¿Ya tienes una cuenta?',
      'checkout.loginLink': 'Inicia sesión aquí',
      ...
      'checkout.company_field': 'Empresa (Opcional)',
      'checkout.orderPlacedDesc': 'Gracias por su pedido. Recibirá un email de confirmación en breve.',
      'checkout.orderFailed': 'Pedido fallido',
      'checkout.stripePayment': 'Tarjeta de Crédito/Débito (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Por favor, introduce un código de cupón',
      'checkout.voucherApplied': '¡Cupón Aplicado!',
      'checkout.voucherDiscountApplied': 'Descuento de {0} {1} aplicado.',
      'checkout.invalidVoucher': 'Código de cupón inválido',
      'checkout.voucherValidationFailed': 'Error al validar el cupón. Inténtalo de nuevo.',
      'checkout.emailPlaceholder': 'tu@email.com',
      'checkout.phonePlaceholder': '+34 6XX XXX XXX',
      'checkout.countyPlaceholder': 'ej. Madrid, Barcelona',
      'checkout.selectCountry': 'Seleccionar país',
      'checkout.selectPayment': 'Seleccionar método de pago',
  ...
  fr: {
    ...
    'checkout.error': 'Erreur lors de la commande',
      ...
      'checkout.invoiceDetails': 'Détails de Facturation',
      'checkout.clientType': 'Type de Client',
      'checkout.individual': 'Particulier',
      'checkout.company': 'Entreprise',
      'checkout.identityDocument': 'Document d\'Identité (Série/Numéro)',
      'checkout.identityDocumentHint': 'Série et numéro de la carte d\'identité (optionnel)',
      'checkout.companyData': 'Données d\'entreprise pour la facturation',
      'checkout.companyName': 'Nom de l\'Entreprise',
      'checkout.vatNumber': 'Numéro de TVA',
      'checkout.registrationNumber': 'Numéro d\'Immatriculation',
      'checkout.sameAsBilling': 'L\'adresse de facturation est identique à l\'adresse de livraison',
      'checkout.subtotal': 'Sous-total',
      'checkout.shipping': 'Livraison',
      'checkout.shippingFree': 'Gratuit',
      'checkout.vatIncluded': 'TVA ({0}% incluse)',
      'checkout.voucherCode': 'Code Promo',
      'checkout.applyVoucher': 'Appliquer',
      'checkout.removeVoucher': 'Supprimer le code promo',
      'checkout.total': 'Total',
      ...
      'checkout.county': 'Département',
      'checkout.cashOnDelivery': 'Paiement à la Livraison',
      'checkout.cashOnDeliveryDesc': 'Payez à la réception de votre commande',
      'checkout.cashOnDeliveryNote': 'Veuillez préparer le montant exact',
      'checkout.notes': 'Notes de Commande',
      'checkout.notesPlaceholder': 'Instructions spéciales pour votre commande...',
      'checkout.emptyCart': 'Votre panier est vide',
      'checkout.emptyCartDesc': 'Ajoutez des produits à votre panier avant de passer commande.',
      'checkout.goShopping': 'Faire du Shopping',
      'checkout.guestEmail': 'Adresse Email',
      'checkout.loginPrompt': 'Vous avez déjà un compte ?',
      'checkout.loginLink': 'Connectez-vous ici',
      ...
      'checkout.company_field': 'Entreprise (Optionnel)',
      'checkout.orderPlacedDesc': 'Merci pour votre commande. Vous recevrez un email de confirmation sous peu.',
      'checkout.orderFailed': 'Commande échouée',
      'checkout.stripePayment': 'Carte de Crédit/Débit (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Veuillez entrer un code promo',
      'checkout.voucherApplied': 'Coupon Appliqué!',
      'checkout.voucherDiscountApplied': 'Réduction de {0} {1} appliquée.',
      'checkout.invalidVoucher': 'Code promo invalide',
      'checkout.voucherValidationFailed': 'Échec de la validation du coupon. Veuillez réessayer.',
      'checkout.emailPlaceholder': 'votre@email.com',
      'checkout.phonePlaceholder': '+33 6XX XXX XXX',
      'checkout.countyPlaceholder': 'ex. Paris, Lyon',
      'checkout.selectCountry': 'Sélectionner le pays',
      'checkout.selectPayment': 'Sélectionner le mode de paiement',
  ...
  de: {
    ...
    'checkout.error': 'Fehler bei der Bestellung',
      ...
      'checkout.invoiceDetails': 'Rechnungsdetails',
      'checkout.clientType': 'Kundentyp',
      'checkout.individual': 'Privatperson',
      'checkout.company': 'Unternehmen',
      'checkout.identityDocument': 'Ausweisdokument (Serie/Nummer)',
      'checkout.identityDocumentHint': 'Personalausweis Serie und Nummer (optional)',
      'checkout.companyData': 'Firmendaten für die Rechnungsstellung',
      'checkout.companyName': 'Firmenname',
      'checkout.vatNumber': 'USt-IdNr.',
      'checkout.registrationNumber': 'Registrierungsnummer',
      'checkout.sameAsBilling': 'Rechnungsadresse ist gleich Lieferadresse',
      'checkout.subtotal': 'Zwischensumme',
      'checkout.shipping': 'Versand',
      'checkout.shippingFree': 'Kostenlos',
      'checkout.vatIncluded': 'MwSt. ({0}% enthalten)',
      'checkout.voucherCode': 'Gutscheincode',
      'checkout.applyVoucher': 'Einlösen',
      'checkout.removeVoucher': 'Gutschein entfernen',
      'checkout.total': 'Gesamt',
      'checkout.next': 'Weiter',
      'checkout.back': 'Zurück',
      'checkout.stepContact': 'Kontakt',
      'checkout.stepAddress': 'Adresse',
      'checkout.stepPayment': 'Zahlung',
      'checkout.county': 'Landkreis',
      'checkout.cashOnDelivery': 'Nachnahme',
      'checkout.cashOnDeliveryDesc': 'Bezahlung bei Lieferung',
      'checkout.cashOnDeliveryNote': 'Bitte halten Sie den genauen Betrag bereit',
      'checkout.notes': 'Bestellhinweise',
      'checkout.notesPlaceholder': 'Besondere Anweisungen für Ihre Bestellung...',
      'checkout.emptyCart': 'Ihr Warenkorb ist leer',
      'checkout.emptyCartDesc': 'Fügen Sie Produkte zum Warenkorb hinzu, bevor Sie zur Kasse gehen.',
      'checkout.goShopping': 'Einkaufen gehen',
      'checkout.guestEmail': 'E-Mail-Adresse',
      'checkout.loginPrompt': 'Haben Sie bereits ein Konto?',
      'checkout.loginLink': 'Hier anmelden',
      ...
      'checkout.company_field': 'Firma (Optional)',
      'checkout.orderPlacedDesc': 'Vielen Dank für Ihre Bestellung. Sie erhalten in Kürze eine Bestätigungs-E-Mail.',
      'checkout.orderFailed': 'Bestellung fehlgeschlagen',
      'checkout.stripePayment': 'Kredit-/Debitkarte (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Bitte Gutscheincode eingeben',
      'checkout.voucherApplied': 'Gutschein angewendet!',
      'checkout.voucherDiscountApplied': 'Rabatt von {0} {1} angewendet.',
      'checkout.invalidVoucher': 'Ungültiger Gutscheincode',
      'checkout.voucherValidationFailed': 'Gutscheinvalidierung fehlgeschlagen. Bitte versuchen Sie es erneut.',
      'checkout.emailPlaceholder': 'ihre@email.de',
      'checkout.phonePlaceholder': '+49 1XX XXXX XXXX',
      'checkout.countyPlaceholder': 'z.B. Berlin, München',
      'checkout.selectCountry': 'Land auswählen',
      'checkout.selectPayment': 'Zahlungsart auswählen',
  ...
  ro: {
    ...
    'checkout.error': 'Eroare la plasarea comenzii',
      'checkout.contactInfo': 'Informații de Contact',
      'checkout.billingAddress': 'Adresă de Facturare',
      'checkout.invoiceDetails': 'Date Facturare',
      'checkout.clientType': 'Tip Client',
      'checkout.individual': 'Persoană Fizică',
      'checkout.company': 'Companie',
      'checkout.identityDocument': 'Serie / Număr CI',
      'checkout.identityDocumentHint': 'Serie și număr carte de identitate (opțional)',
      'checkout.companyData': 'Date companie pentru facturare',
      'checkout.companyName': 'Nume Companie',
      'checkout.vatNumber': 'CUI / Cod Fiscal',
      'checkout.registrationNumber': 'Nr. Înregistrare',
      'checkout.sameAsBilling': 'Adresa de facturare este aceeași cu cea de livrare',
      'checkout.subtotal': 'Subtotal',
      'checkout.shipping': 'Transport',
      'checkout.shippingFree': 'Gratuit',
      'checkout.vatIncluded': 'TVA ({0}% inclus)',
      'checkout.voucherCode': 'Cod Voucher',
      'checkout.applyVoucher': 'Aplică',
      'checkout.removeVoucher': 'Elimină voucher',
      'checkout.total': 'Total',
      'checkout.next': 'Continuă',
      'checkout.back': 'Înapoi',
      'checkout.stepContact': 'Contact',
      'checkout.stepAddress': 'Adresă',
      'checkout.stepPayment': 'Plată',
      'checkout.county': 'Județ',
      'checkout.cashOnDelivery': 'Plată la Livrare',
      'checkout.cashOnDeliveryDesc': 'Plătiți când primiți comanda',
      'checkout.cashOnDeliveryNote': 'Vă rugăm să aveți suma exactă pregătită',
      'checkout.notes': 'Note Comandă',
      'checkout.notesPlaceholder': 'Instrucțiuni speciale pentru comanda dvs...',
      'checkout.emptyCart': 'Coșul este gol',
      'checkout.emptyCartDesc': 'Adăugați produse în coș înainte de a finaliza comanda.',
      'checkout.goShopping': 'Mergi la Cumpărături',
      'checkout.guestEmail': 'Adresă de Email',
      'checkout.loginPrompt': 'Ai deja un cont?',
      'checkout.loginLink': 'Conectează-te aici',
      'checkout.firstName': 'Prenume',
      'checkout.lastName': 'Nume',
      'checkout.address': 'Adresă',
      'checkout.city': 'Oraș',
      'checkout.state': 'Regiune',
      'checkout.zipCode': 'Cod Poștal',
      'checkout.country': 'Țară',
      'checkout.phone': 'Telefon',
      'checkout.company_field': 'Companie (Opțional)',
      'checkout.orderPlacedDesc': 'Vă mulțumim pentru comandă. Veți primi un email de confirmare în curând.',
      'checkout.orderFailed': 'Comandă eșuată',
      'checkout.stripePayment': 'Card Bancar (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Vă rugăm introduceți un cod de voucher',
      'checkout.voucherApplied': 'Voucher Aplicat!',
      'checkout.voucherDiscountApplied': 'Reducere de {0} {1} aplicată.',
      'checkout.invalidVoucher': 'Cod voucher invalid',
      'checkout.voucherValidationFailed': 'Validarea voucherului a eșuat. Vă rugăm încercați din nou.',
      'checkout.emailPlaceholder': 'email@exemplu.ro',
      'checkout.phonePlaceholder': '+40 7XX XXX XXX',
      'checkout.countyPlaceholder': 'ex. București, Cluj, Ilfov',
      'checkout.selectCountry': 'Selectează țara',
      'checkout.selectPayment': 'Selectează metoda de plată',
  ...
  it: {
    ...
    'common.sortBy': 'Ordina Per',
      ...
      'checkout.error': 'Errore nell\'effettuare l\'ordine',
      'checkout.contactInfo': 'Informazioni di Contatto',
      'checkout.billingAddress': 'Indirizzo di Fatturazione',
      'checkout.invoiceDetails': 'Dettagli Fattura',
      'checkout.clientType': 'Tipo Cliente',
      'checkout.individual': 'Privato',
      'checkout.company': 'Azienda',
      'checkout.identityDocument': 'Documento d\'Identità (Serie/Numero)',
      'checkout.identityDocumentHint': 'Serie e numero della carta d\'identità (opzionale)',
      'checkout.companyData': 'Dati aziendali per la fatturazione',
      'checkout.companyName': 'Nome Azienda',
      'checkout.vatNumber': 'Partita IVA',
      'checkout.registrationNumber': 'Numero di Registrazione',
      'checkout.sameAsBilling': 'L\'indirizzo di fatturazione è lo stesso dell\'indirizzo di spedizione',
      'checkout.subtotal': 'Subtotale',
      'checkout.shipping': 'Spedizione',
      'checkout.shippingFree': 'Gratuita',
      'checkout.vatIncluded': 'IVA ({0}% inclusa)',
      'checkout.voucherCode': 'Codice Coupon',
      'checkout.applyVoucher': 'Applica',
      'checkout.removeVoucher': 'Rimuovi coupon',
      'checkout.total': 'Totale',
      'checkout.next': 'Avanti',
      'checkout.back': 'Indietro',
      'checkout.stepContact': 'Contatto',
      'checkout.stepAddress': 'Indirizzo',
      'checkout.stepPayment': 'Pagamento',
      'checkout.county': 'Provincia',
      'checkout.cashOnDelivery': 'Contrassegno',
      'checkout.cashOnDeliveryDesc': 'Paga alla consegna dell\'ordine',
      'checkout.cashOnDeliveryNote': 'Si prega di preparare l\'importo esatto',
      'checkout.notes': 'Note Ordine',
      'checkout.notesPlaceholder': 'Istruzioni speciali per il tuo ordine...',
      'checkout.emptyCart': 'Il carrello è vuoto',
      'checkout.emptyCartDesc': 'Aggiungi prodotti al carrello prima di procedere all\'acquisto.',
      'checkout.goShopping': 'Vai allo Shopping',
      'checkout.guestEmail': 'Indirizzo Email',
      'checkout.loginPrompt': 'Hai già un account?',
      'checkout.loginLink': 'Accedi qui',
      'checkout.firstName': 'Nome',
      'checkout.lastName': 'Cognome',
      'checkout.address': 'Indirizzo',
      'checkout.city': 'Città',
      'checkout.state': 'Stato',
      'checkout.zipCode': 'Codice Postale',
      'checkout.country': 'Paese',
      'checkout.phone': 'Telefono',
      'checkout.company_field': 'Azienda (Opzionale)',
      'checkout.orderPlacedDesc': 'Grazie per il tuo ordine. Riceverai un\'email di conferma a breve.',
      'checkout.orderFailed': 'Ordine fallito',
      'checkout.stripePayment': 'Carta di Credito/Debito (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Inserisci un codice promozionale',
      'checkout.voucherApplied': 'Coupon Applicato!',
      'checkout.voucherDiscountApplied': 'Sconto di {0} {1} applicato.',
      'checkout.invalidVoucher': 'Codice promozionale non valido',
      'checkout.voucherValidationFailed': 'Validazione coupon fallita. Riprova.',
      'checkout.emailPlaceholder': 'tua@email.it',
      'checkout.phonePlaceholder': '+39 3XX XXX XXXX',
      'checkout.countyPlaceholder': 'es. Roma, Milano',
      'checkout.selectCountry': 'Seleziona paese',
      'checkout.selectPayment': 'Seleziona metodo di pagamento',
  ...
  pt: {
    ...
    'common.sortBy': 'Ordenar Por',
      ...
      'checkout.error': 'Erro ao realizar o pedido',
      'checkout.contactInfo': 'Informações de Contato',
      'checkout.billingAddress': 'Endereço de Faturação',
      'checkout.invoiceDetails': 'Detalhes da Fatura',
      'checkout.clientType': 'Tipo de Cliente',
      'checkout.individual': 'Particular',
      'checkout.company': 'Empresa',
      'checkout.identityDocument': 'Documento de Identidade (Série/Número)',
      'checkout.identityDocumentHint': 'Série e número do documento de identidade (opcional)',
      'checkout.companyData': 'Dados da empresa para faturação',
      'checkout.companyName': 'Nome da Empresa',
      'checkout.vatNumber': 'Número de IVA (NIF)',
      'checkout.registrationNumber': 'Número de Registo',
      'checkout.sameAsBilling': 'O endereço de faturação é o mesmo que o de envio',
      'checkout.subtotal': 'Subtotal',
      'checkout.shipping': 'Envio',
      'checkout.shippingFree': 'Grátis',
      'checkout.vatIncluded': 'IVA ({0}% incluído)',
      'checkout.voucherCode': 'Código de Voucher',
      'checkout.applyVoucher': 'Aplicar',
      'checkout.removeVoucher': 'Remover voucher',
      'checkout.total': 'Total',
      'checkout.next': 'Seguinte',
      'checkout.back': 'Voltar',
      'checkout.stepContact': 'Contato',
      'checkout.stepAddress': 'Endereço',
      'checkout.stepPayment': 'Pagamento',
      'checkout.county': 'Distrito',
      'checkout.cashOnDelivery': 'Pagamento na Entrega',
      'checkout.cashOnDeliveryDesc': 'Pague quando receber o seu pedido',
      'checkout.cashOnDeliveryNote': 'Por favor tenha o valor exato preparado',
      'checkout.notes': 'Notas do Pedido',
      'checkout.notesPlaceholder': 'Instruções especiais para o seu pedido...',
      'checkout.emptyCart': 'O seu carrinho está vazio',
      'checkout.emptyCartDesc': 'Adicione produtos ao carrinho antes de finalizar a compra.',
      'checkout.goShopping': 'Ir às Compras',
      'checkout.guestEmail': 'Endereço de Email',
      'checkout.loginPrompt': 'Já tem uma conta?',
      'checkout.loginLink': 'Inicie sessão aqui',
      ...
      'checkout.company_field': 'Empresa (Opcional)',
      'checkout.orderPlacedDesc': 'Obrigado pelo seu pedido. Receberá um email de confirmação em breve.',
      'checkout.orderFailed': 'Pedido falhado',
      'checkout.stripePayment': 'Cartão de Crédito/Débito (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'Por favor, insira um código de cupom',
      'checkout.voucherApplied': 'Cupom Aplicado!',
      'checkout.voucherDiscountApplied': 'Desconto de {0} {1} aplicado.',
      'checkout.invalidVoucher': 'Código de cupom inválido',
      'checkout.voucherValidationFailed': 'Falha ao validar cupom. Tente novamente.',
      'checkout.emailPlaceholder': 'seu@email.com',
      'checkout.phonePlaceholder': '+55 XX XXXXX-XXXX',
      'checkout.countyPlaceholder': 'ex. Lisboa, Porto',
      'checkout.selectCountry': 'Selecionar país',
      'checkout.selectPayment': 'Selecionar método de pagamento',
  ...
  zh: {
    ...
    'common.sortBy': '排序方式',
      ...
      'checkout.success': '订单已成功提交！',
      'checkout.error': '下单时出错',
      'checkout.contactInfo': '联系信息',
      'checkout.billingAddress': '账单地址',
      'checkout.invoiceDetails': '发票详情',
      'checkout.clientType': '客户类型',
      'checkout.individual': '个人',
      'checkout.company': '公司',
      'checkout.identityDocument': '身份证件（系列/号码）',
      'checkout.identityDocumentHint': '身份证系列号和号码（可选）',
      'checkout.companyData': '开票公司信息',
      'checkout.companyName': '公司名称',
      'checkout.vatNumber': '增值税号',
      'checkout.registrationNumber': '注册号',
      'checkout.sameAsBilling': '账单地址与收货地址相同',
      'checkout.subtotal': '小计',
      'checkout.shipping': '运费',
      'checkout.shippingFree': '免费',
      'checkout.vatIncluded': '增值税（含{0}%）',
      'checkout.voucherCode': '优惠券代码',
      'checkout.applyVoucher': '使用',
      'checkout.removeVoucher': '移除优惠券',
      'checkout.total': '合计',
      'checkout.next': '下一步',
      'checkout.back': '返回',
      'checkout.stepContact': '联系方式',
      'checkout.stepAddress': '地址',
      'checkout.stepPayment': '支付',
      'checkout.county': '区/县',
      'checkout.cashOnDelivery': '货到付款',
      'checkout.cashOnDeliveryDesc': '收到订单后付款',
      'checkout.cashOnDeliveryNote': '请准备好零钱',
      'checkout.notes': '订单备注',
      'checkout.notesPlaceholder': '订单特殊说明...',
      'checkout.emptyCart': '购物车为空',
      'checkout.emptyCartDesc': '请先将商品添加到购物车再结账。',
      'checkout.goShopping': '去购物',
      'checkout.guestEmail': '电子邮箱',
      'checkout.loginPrompt': '已有账号？',
      'checkout.loginLink': '在此登录',
      ...
      'checkout.country': '国家',
      'checkout.phone': '电话',
      'checkout.company_field': '公司（可选）',
      'checkout.orderPlacedDesc': '感谢您的订单。您将很快收到确认邮件。',
      'checkout.orderFailed': '订单失败',
      'checkout.stripePayment': '信用卡/借记卡 (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': '请输入优惠码',
      'checkout.voucherApplied': '优惠券已应用！',
      'checkout.voucherDiscountApplied': '已应用 {0} {1} 折扣。',
      'checkout.invalidVoucher': '无效的优惠码',
      'checkout.voucherValidationFailed': '验证优惠券失败，请重试。',
      'checkout.emailPlaceholder': 'your@email.com',
      'checkout.phonePlaceholder': '+86 XXX XXXX XXXX',
      'checkout.countyPlaceholder': '例如：北京、上海',
  ...
  ja: {
    ...
    'common.sortBy': '並び順',
      ...
      'checkout.success': '注文が完了しました！',
      'checkout.error': '注文エラー',
      'checkout.contactInfo': '連絡先情報',
      'checkout.billingAddress': '請求先住所',
      'checkout.invoiceDetails': '請求書詳細',
      'checkout.clientType': '顧客タイプ',
      'checkout.individual': '個人',
      'checkout.company': '法人',
      'checkout.identityDocument': '身分証明書（シリーズ/番号）',
      'checkout.identityDocumentHint': '身分証明書のシリーズと番号（任意）',
      'checkout.companyData': '請求用会社データ',
      'checkout.companyName': '会社名',
      'checkout.vatNumber': '納税者番号',
      'checkout.registrationNumber': '登録番号',
      'checkout.sameAsBilling': '請求先住所は配送先住所と同じです',
      'checkout.subtotal': '小計',
      'checkout.shipping': '送料',
      'checkout.shippingFree': '無料',
      'checkout.vatIncluded': '消費税（{0}%込み）',
      'checkout.voucherCode': 'クーポンコード',
      'checkout.applyVoucher': '適用',
      'checkout.removeVoucher': 'クーポンを削除',
      'checkout.total': '合計',
      'checkout.next': '次へ',
      'checkout.back': '戻る',
      'checkout.stepContact': '連絡先',
      'checkout.stepAddress': '住所',
      'checkout.stepPayment': 'お支払い',
      'checkout.county': '郡/区',
      'checkout.cashOnDelivery': '代金引換',
      'checkout.cashOnDeliveryDesc': '商品受け取り時にお支払い',
      'checkout.cashOnDeliveryNote': 'おつりのないようご用意ください',
      'checkout.notes': '注文メモ',
      'checkout.notesPlaceholder': '注文に関する特別な指示...',
      'checkout.emptyCart': 'カートは空です',
      'checkout.emptyCartDesc': 'チェックアウトの前にカートに商品を追加してください。',
      'checkout.goShopping': 'ショッピングへ',
      'checkout.guestEmail': 'メールアドレス',
      'checkout.loginPrompt': 'アカウントをお持ちですか？',
      'checkout.loginLink': 'こちらからログイン',
      'checkout.firstName': '名',
      'checkout.lastName': '姓',
      'checkout.address': '住所',
      'checkout.city': '市区町村',
      ...
      'checkout.country': '国',
      'checkout.phone': '電話番号',
      'checkout.company_field': '会社名（任意）',
      'checkout.orderPlacedDesc': 'ご注文ありがとうございます。確認メールがまもなく届きます。',
      'checkout.orderFailed': '注文に失敗しました',
      'checkout.stripePayment': 'クレジット/デビットカード (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'クーポンコードを入力してください',
      'checkout.voucherApplied': 'クーポン適用済み！',
      'checkout.voucherDiscountApplied': '{0} {1} の割引が適用されました。',
      'checkout.invalidVoucher': '無効なクーポンコード',
      'checkout.voucherValidationFailed': 'クーポンの検証に失敗しました。もう一度お試しください。',
      'checkout.emailPlaceholder': 'your@email.com',
      'checkout.phonePlaceholder': '+81 XX XXXX XXXX',
      'checkout.countyPlaceholder': '例：東京、大阪',
      'checkout.selectCountry': '国を選択',
      'checkout.selectPayment': '支払い方法を選択',
  ...
  ko: {
    ...
    'common.sortBy': '정렬 기준',
      ...
      'checkout.success': '주문이 성공적으로 완료되었습니다!',
      'checkout.error': '주문 오류',
      'checkout.contactInfo': '연락처 정보',
      'checkout.billingAddress': '청구 주소',
      'checkout.invoiceDetails': '청구서 세부정보',
      'checkout.clientType': '고객 유형',
      'checkout.individual': '개인',
      'checkout.company': '기업',
      'checkout.identityDocument': '신분증 (시리즈/번호)',
      'checkout.identityDocumentHint': '신분증 시리즈 및 번호 (선택사항)',
      'checkout.companyData': '청구용 회사 데이터',
      'checkout.companyName': '회사명',
      'checkout.vatNumber': '사업자등록번호',
      'checkout.registrationNumber': '등록번호',
      'checkout.sameAsBilling': '청구 주소가 배송 주소와 동일합니다',
      'checkout.subtotal': '소계',
      'checkout.shipping': '배송비',
      'checkout.shippingFree': '무료',
      'checkout.vatIncluded': '부가세 ({0}% 포함)',
      'checkout.voucherCode': '할인 코드',
      'checkout.applyVoucher': '적용',
      'checkout.removeVoucher': '할인 코드 제거',
      'checkout.total': '합계',
      'checkout.next': '다음',
      'checkout.back': '뒤로',
      'checkout.stepContact': '연락처',
      'checkout.stepAddress': '주소',
      'checkout.stepPayment': '결제',
      'checkout.county': '군/구',
      'checkout.cashOnDelivery': '착불',
      'checkout.cashOnDeliveryDesc': '주문 수령 시 결제',
      'checkout.cashOnDeliveryNote': '정확한 금액을 준비해 주세요',
      'checkout.notes': '주문 메모',
      'checkout.notesPlaceholder': '주문에 대한 특별 지시사항...',
      'checkout.emptyCart': '장바구니가 비어 있습니다',
      'checkout.emptyCartDesc': '결제 전에 장바구니에 상품을 추가하세요.',
      'checkout.goShopping': '쇼핑하러 가기',
      'checkout.guestEmail': '이메일 주소',
      'checkout.loginPrompt': '이미 계정이 있으신가요?',
      'checkout.loginLink': '여기서 로그인',
      ...
      'checkout.country': '국가',
      'checkout.phone': '전화번호',
      'checkout.company_field': '회사 (선택사항)',
      'checkout.orderPlacedDesc': '주문해 주셔서 감사합니다. 곧 확인 이메일을 받으실 것입니다.',
      'checkout.orderFailed': '주문 실패',
      'checkout.stripePayment': '신용/체크카드 (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': '바우처 코드를 입력해주세요',
      'checkout.voucherApplied': '바우처 적용됨!',
      'checkout.voucherDiscountApplied': '{0} {1} 할인이 적용되었습니다.',
      'checkout.invalidVoucher': '유효하지 않은 바우처 코드',
      'checkout.voucherValidationFailed': '바우처 검증에 실패했습니다. 다시 시도해주세요.',
      'checkout.emailPlaceholder': 'your@email.com',
      'checkout.phonePlaceholder': '+82 10 XXXX XXXX',
      'checkout.countyPlaceholder': '예: 서울, 부산',
      'checkout.selectCountry': '국가 선택',
      'checkout.selectPayment': '결제 방법 선택',
  ...
  ar: {
    ...
    'common.sortBy': 'ترتيب حسب',
      ...
      'checkout.error': 'خطأ في تقديم الطلب',
      'checkout.contactInfo': 'معلومات الاتصال',
      'checkout.billingAddress': 'عنوان الفاتورة',
      'checkout.invoiceDetails': 'تفاصيل الفاتورة',
      'checkout.clientType': 'نوع العميل',
      'checkout.individual': 'فرد',
      'checkout.company': 'شركة',
      'checkout.identityDocument': 'وثيقة الهوية (السلسلة/الرقم)',
      'checkout.identityDocumentHint': 'سلسلة ورقم بطاقة الهوية (اختياري)',
      'checkout.companyData': 'بيانات الشركة للفوترة',
      'checkout.companyName': 'اسم الشركة',
      'checkout.vatNumber': 'رقم ضريبة القيمة المضافة',
      'checkout.registrationNumber': 'رقم التسجيل',
      'checkout.sameAsBilling': 'عنوان الفاتورة هو نفس عنوان الشحن',
      'checkout.subtotal': 'المجموع الفرعي',
      'checkout.shipping': 'الشحن',
      'checkout.shippingFree': 'مجاني',
      'checkout.vatIncluded': 'ضريبة القيمة المضافة ({0}% مشمولة)',
      'checkout.voucherCode': 'رمز القسيمة',
      'checkout.applyVoucher': 'تطبيق',
      'checkout.removeVoucher': 'إزالة القسيمة',
      'checkout.total': 'المجموع',
      'checkout.next': 'التالي',
      'checkout.back': 'رجوع',
      'checkout.stepContact': 'الاتصال',
      'checkout.stepAddress': 'العنوان',
      'checkout.stepPayment': 'الدفع',
      'checkout.county': 'المحافظة',
      'checkout.cashOnDelivery': 'الدفع عند الاستلام',
      'checkout.cashOnDeliveryDesc': 'ادفع عند استلام طلبك',
      'checkout.cashOnDeliveryNote': 'يرجى تحضير المبلغ المحدد',
      'checkout.notes': 'ملاحظات الطلب',
      'checkout.notesPlaceholder': 'تعليمات خاصة لطلبك...',
      'checkout.emptyCart': 'سلة التسوق فارغة',
      'checkout.emptyCartDesc': 'أضف منتجات إلى سلة التسوق قبل إتمام الشراء.',
      'checkout.goShopping': 'اذهب للتسوق',
      'checkout.guestEmail': 'عنوان البريد الإلكتروني',
      'checkout.loginPrompt': 'لديك حساب بالفعل؟',
      'checkout.loginLink': 'سجل الدخول هنا',
      ...
      'checkout.company_field': 'الشركة (اختياري)',
      'checkout.orderPlacedDesc': 'شكراً لطلبك. ستتلقى بريداً إلكترونياً للتأكيد قريباً.',
      'checkout.orderFailed': 'فشل الطلب',
      'checkout.stripePayment': 'بطاقة ائتمان/خصم (Stripe)',
      'checkout.revolutPayment': 'Revolut Pay',
      'checkout.paypalPayment': 'PayPal',
      'checkout.enterVoucherCode': 'يرجى إدخال رمز القسيمة',
      'checkout.voucherApplied': 'تم تطبيق القسيمة!',
      'checkout.voucherDiscountApplied': 'تم تطبيق خصم {0} {1}.',
      'checkout.invalidVoucher': 'رمز قسيمة غير صالح',
      'checkout.voucherValidationFailed': 'فشل في التحقق من القسيمة. يرجى المحاولة مرة أخرى.',
      'checkout.emailPlaceholder': 'your@email.com',
      'checkout.phonePlaceholder': '+966 5X XXX XXXX',
      'checkout.countyPlaceholder': 'مثال: الرياض، جدة',
